...
const EditBlog = () => {
    ...
    // Fetch Single Blog
    useEffect(() => {
        http.get(`blog/${id}/edit`).then(res => {
            if (res.data.status == true) {
                setTitle(res.data.blog.title)
                setShortDecs(res.data.blog.short_description)
                                ...
                                <div className="card border-0 shadow rounded-3 p-4">
                                    <div className="card-body">
                                        ...
                                        <div className='d-flex align-items-center justify-content-between'>
                                            <h4 className='text-uppercase fw-bold '>Edit Blog</h4>
                                            <Link to={'/admin/blogs'} className='btn btn-sm btn-dark'>
                                                BACK
                                            </Link>
                                        </div>
